...
python -m prediction_arb.cli paper-loop --input data/monitor-short-all.jsonl --interval 60 --enter
...
- `portfolio-init`, `paper-enter`, `paper-sync`, `paper-loop`, `paper-close`, and `portfolio-status` maintain local paper-trading state in `data/portfolio.json`.
